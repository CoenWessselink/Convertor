"""PySide6/QVTK host for the V2 project renderer and controller."""
...
if qt_available():
    ...
    if QVTKRenderWindowInteractor is not None:
        ...
        class VtkProjectWidget(QVTKRenderWindowInteractor):  # type: ignore[misc]
            ...
            def __init__(self, parent: Any | None = None) -> None:
                ...
                self.setObjectName("cwsVtkProjectWidget")
                self.setMinimumSize(560, 360)
                self.setMouseTracking(True)
                self.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
                self._backend = VtkProjectBackend(
            ...
            @property
            def backend(self) -> VtkProjectBackend:
        ...
        class VtkProjectWidget:  # pragma: no cover
