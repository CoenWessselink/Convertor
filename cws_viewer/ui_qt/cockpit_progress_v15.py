...
from cws_viewer.ui_qt.cockpit_t5_v15 import CwsViewerV15T5CockpitWindow, V15_T5_VERSION
...
def run_cws_viewer_cockpit_v15(
    ...
    *,
    ...
    """Open a project in the V15 T5 workspace while keeping progress visible."""
    ...
    loading = create_loading_dialog(version=V15_T5_VERSION, source_path=path)
    ...
    def geometry_progress(fraction: float, message: str) -> None:
        ...
        loading.set_progress(
            ...
            "IFC/STEP-displaygeometrie wordt crash-geïsoleerd opgebouwd; reviewdata blijft een aparte laag.",
        )
    ...
    try:
        ...
        loading.set_progress(
            0.94,
            "V15 T5 engineering workspace voorbereiden…",
            "Project Explorer, view/clipping, selection/meten en Saved Views/Markups/Issues worden gekoppeld.",
        )
        window = CwsViewerV15T5CockpitWindow(result)
        ...
        if ci_smoke:
            ...
            QtCore.QTimer.singleShot(800, verify)
        return int(app.exec())
    finally:
