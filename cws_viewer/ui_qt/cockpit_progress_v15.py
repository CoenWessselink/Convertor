...
from cws_viewer.ui_qt.cockpit_v15 import CwsViewerV15CockpitWindow, V15_VERSION
...
def run_cws_viewer_cockpit_v15(
    ...
    *,
    ...
    """Open a project in the V15 workspace while keeping progress visible."""
    ...
    loading = create_loading_dialog(version=V15_VERSION, source_path=path)
    loading.set_progress(
        0.04,
        "Projectstructuur openen…",
        "CWS bouwt de canonical projectscene en houdt de brongeometrie ongewijzigd.",
    )
    ...
    def geometry_progress(fraction: float, message: str) -> None:
        ...
        loading.set_progress(
            ...
            "IFC/STEP-displaygeometrie wordt crash-geïsoleerd opgebouwd; productiegeometrie blijft canonical.",
        )
    ...
    try:
        ...
        loading.set_progress(
            0.94,
            "V15 engineering workspace voorbereiden…",
            "Project Explorer, 3D Viewer, properties en reviewwerkruimtes worden gekoppeld.",
        )
        window = CwsViewerV15CockpitWindow(result)
