# SteelConverter - CWS Convertor 0.10.21-beta-dev implementation snapshot
...
voor versie 0.10.21-beta-dev bewust `CWS_Convertor`, zodat bestaande projecten,
...
Versie **0.10.21-beta-dev** bouwt verder op de bewezen conversiekern en de
...
- veldniveau-revisiebaselines op canonieke object-ID, inclusief gewijzigde
  groepssleutels, geometrie-/manufacturinghash, productiebewerkingen en rode
...
workflow en Inno Setup-configuratie zijn bijgewerkt naar 0.10.21-beta-dev. Een
