...
"""PyInstaller onedir build for the isolated CWS Viewer V14 UX candidate."""
...
hiddenimports += [
    ...
    "cws_viewer.ui_qt.cockpit", "cws_viewer.ui_qt.vtk_real_project_widget",
...
a = Analysis(
    [str(ROOT / "CWS_Viewer_V14_Standalone.py")],
