...
hiddenimports += [
    ...
    "cws_viewer.ui_qt.cockpit_progress_v15", "cws_viewer.ui_qt.cockpit_t8_v15",
    "cws_viewer.ui_qt.export_center_v15", "cws_viewer.export_center.service",
    "cws_viewer.ui_qt.manufacturing_faces_v15", "cws_convertor.manufacturing.faces",
    "cws_convertor.manufacturing.faces_model",
    "cws_viewer.ui_qt.vtk_real_project_widget",
