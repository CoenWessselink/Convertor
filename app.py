...
class ConverterApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        self.notebook.add(self.converter_tab, text="Inlezen / Converteren")
        self.notebook.add(self.project_tab, text="Project")
        self.notebook.add(self.pdf_tab, text="PDF / Tekening")
        self.notebook.add(self.preview_tab, text="Conversiecontrole")
        self.notebook.add(self.database_tab, text="Profielen")
