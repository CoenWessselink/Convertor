#!/usr/bin/env python3
"""Run Viewer V8 smoke scripts as isolated subprocesses and persist evidence.
...
OUT = ROOT / "validation" / "viewer_v8_full_smokes"
LOGS = OUT / "logs"
...
def aggregate() -> dict:
    ...
    summary = {
        "schema": "cws-viewer-v8-full-smoke-summary-1.0",
        "python": sys.version,
    ...
    (OUT / "VIEWER_V8_FULL_SMOKE_SUMMARY.json").write_text(
