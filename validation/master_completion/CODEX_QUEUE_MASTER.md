...
Generated from `072f4d442c7b80090ab197bd8ace9273a43c686c` on branch `agent/cws-product-ui-reintegration-v1`. This ledger never converts missing external evidence into PASS.
...
| Q002 | Viewer Loader Engine V2 and cold-load performance closeout | Q001 | PARTIAL | HVPC first-cold exact load is circa 71 seconds and exceeds the 3-5 second target. |
