...
CORE_REQUIREMENTS = (
    ...
    ("F3-001", 3, "One production drawing engine emits vector geometry, dimensions, annotations and title blocks", ("cws_convertor/drawings/", "cws_convertor/ui_qt/engineering_drawing.py"), ("tests/test_geometry_worker_and_drawing_regressions.py",)),
    ("F3-002", 3, "Production drawing PDF remains sharp at 800 percent and is not a full-page raster", ("cws_convertor/ui_qt/engineering_drawing.py",), ("tests/part_drawing_standard_smoke.py",)),
    ("F3-003", 3, "Drawing linter blocks incomplete, stale, clipped or raster-only production pages", ("cws_convertor/ui_qt/engineering_drawing.py",), ("tests/test_geometry_worker_and_drawing_regressions.py",)),
    ("F3-004", 3, "Trusted PDF payload and hash verification fails closed on tamper", ("pdf_support.py",), ("tests/final_gap_closure_smoke.py",)),
