...
TESTS = (
    ...
    ("drawing", "tests/interactive_dimension_editor_v2_smoke.py"),
    ("drawing", "tests/interactive_dimension_editor_v2_acceptance_smoke.py"),
    ("gui", "tests/interactive_dimension_editor_v2_gui_smoke.py"),
