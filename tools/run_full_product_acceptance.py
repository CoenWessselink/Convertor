...
def runtime_inventory(project: Path | None = None) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    safe_method_arguments: dict[str, tuple[Any, ...]] = {
        ...
        "cws_convertor.ui_qt.converter_panel.ConverterPanel.set_project_selection": (None, None),
        "cws_convertor.ui_qt.machine_settings_panel.MachineSettingsPanel.set_project": (None,),
        "cws_convertor.ui_qt.nesting_visualization.ProfileNestingVisualization.set_record": ({},),
        "cws_convertor.ui_qt.phase3_workspaces.ProfileNestingPanel.set_context": (None, None),
        "cws_convertor.ui_qt.phase3_workspaces.Phase3ExportCenterPanel.set_context": (None, None),
        "cws_convertor.ui_qt.project_workspace.IntegratedProjectWorkspaceWidget.open_source_preview": (
            operation_import,
        ),
        "cws_convertor.ui_qt.v5_workspaces.ProjectOverviewPanel.set_context": (None, None),
        "cws_convertor.ui_qt.v5_workspaces.ProjectStructurePanel.set_context": (None, None),
        "cws_convertor.ui_qt.v5_workspaces.ProjectReviewsPanel.set_context": (None, None),
        "cws_convertor.ui_qt.v5_workspaces.PrintCenterPanel.set_context": (None, None),
        "cws_convertor.ui_qt.v5_workspaces.ManufacturabilityPanel.set_context": (None, None),
        "cws_convertor.ui_qt.workspace_pages.ProfilesPanel.set_context": (None, None),
