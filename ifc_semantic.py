...
def write_semantic_plate_ifc(
    ...
    *,
    ...
    lines: list[str] = [
        ...
        f"FILE_NAME('{_escape(Path(output_path).name)}','{timestamp}',('NC1 STEP IFC Converter'),('NC1 STEP IFC Converter'),'NC1 STEP IFC Converter v{_escape(part.converter_version)}','NC1 STEP IFC Converter v{_escape(part.converter_version)}','');",
        "FILE_SCHEMA(('IFC4'));",
        "ENDSEC;",
        "DATA;",
        ...
        f"#4=IFCAPPLICATION(#2,'{_escape(part.converter_version)}','NC1 STEP IFC Converter','NC1STEPIFC');",
