...
| B - Viewer & Import Accuracy | Correct repeatable import; source/model/mesh trace; production viewer; measurements; sections; compare; debug mode; visual, golden and large-model regression | Semantic IFC/STEP import, source locators, exact single-solid STEP selection, entity-specific IFC tessellation, SteelModel-bound host UI, hash-bound STEP/IFC/canonical mesh resources, built-in VTK/Tk rendering, synchronized picking/selection, structural visual golden and generated 600-instance load regression | **In progress**: batches 1-2 are tested; measurements, sections, compare, progressive whole-project loading and owner-validated large-model acceptance remain open |
