...
| 2 | Part Workbench plus deterministic canonical rebuild and all format gates | Schema 2.5/Workbench 1.1, exact arcs, custom sections, worked profiles, source comparison and hash-bound NC1/STEP/IFC/PDF matrix | Complete locally; branch CI gate required |
...
| 20 | All old regressions remain green | 118-test local smoke suite with seven explicit fixture skips; phase-2 Windows gate required before merge |
