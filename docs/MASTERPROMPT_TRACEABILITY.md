...
| 2 | Plate with true arcs/radii | Analytical storage/validation covered; exact rebuilt arc comparison still open |
| 3 | I/HEA profile | Exact unworked catalogue profile build covered; worked profiles open |
...
| 9 | Contour closure/self-intersection | Closure covered; explicit self-intersection test open |
| 10 | Placement does not change manufacturing identity | Covered |
| 11 | Material/profile/feature/mirror identity changes | Feature and mirror covered; complete matrix open |
| 12 | Undo/redo and persistent audit | Covered |
| 13 | Save/reopen preserves edits | Covered |
| 14 | Format-specific gates | Generic blocking/invalidation covered; complete per-format matrix open |
| 15 | Canonical to NC1 to canonical | Open |
| 16 | Canonical to STEP to canonical | Open |
