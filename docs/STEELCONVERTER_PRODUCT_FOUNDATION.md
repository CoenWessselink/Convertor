...
| C - Production Editor | Parametric production edits, holes/slots/copes/cuts/bevels, scribing, preview, undo/redo and audit | **In progress**; batch 1 adds the typed feature contract, profile/material/mark edits, exact plate slots and rectangular cutouts, marking intent, strict contact proposals and integrated preview. Native VTK placement, complex profile/end/bevel geometry and owner acceptance remain open |
